export const questionsData = {
  ...
  },
  {
    ...
    "analysis": {
      ...
      "concepts_to_understand": "The scope baseline, encompassing the project scope statement, WBS, and WBS dictionary, is paramount in the Validate Scope process. It contains the acceptance criteria for deliverables, which are the formal requirements against which deliverables are measured for customer acceptance. Any deviations, even minor ones, must be assessed against these criteria to determine if they warrant rejection or can be accepted.",
      "additional_notes": "Validate Scope is to obtain formal acceptance of deliverables. It ensures that deliverables match the scope defined in the Project Scope Statement and requirements documentation. Without this validation, the project cannot be officially considered complete.\n\nInputs\n1. Project Management Plan\n    * Especially the scope management plan, which defines how scope will be validated and controlled.\n    * The scope baseline (including the scope statement, WBS, and WBS dictionary) is used to assess deliverables.\n2. Requirements Documentation\n    * Details all the project requirements. Used as the basis for comparison during validation.\n3. Requirements Traceability Matrix\n    * Links requirements to their source and tracks their fulfillment. It ensures that each deliverable meets a specific requirement.\n4. Verified Deliverables\n    * Deliverables that have already passed quality control (from the Control Quality process) and are ready for formal approval.\n5. Work Performance Data\n    * Provides information on the status of deliverables, such as completion percentage or test results.\n\nTools and Techniques\n1. Inspection\n    * The key technique in this process. It involves reviewing work products (through walkthroughs, reviews, audits) to verify they meet requirements.\n    * May include product testing, measurements, or demonstrations.\n2. Decision Making\n    * Often involves voting or a group decision-making technique to approve or reject deliverables.\n\nOutputs\n1. Accepted Deliverables\n    * Deliverables that have been formally accepted by the customer or sponsor. These are a prerequisite for project or phase closure.\n2. Work Performance Information\n    * Provides details on which deliverables were accepted and which were rejected, along with reasons.\n3. Change Requests\n    * If deliverables are rejected or if changes are needed, change requests are generated and processed through Integrated Change Control.\n4. Project Document Updates\n    * Updates to documents like the lessons learned register, requirements documentation, and requirements traceability matrix based on validation outcomes.\n\nKey Points\n* Validate Scope is about formal acceptance, not internal quality checks.\n* It typically follows Control Quality, which ensures deliverables are internally verified before being presented to the customer.\n* Helps minimize scope creep by confirming only approved work is accepted.\n* Formal sign-off from stakeholders is critical to ensure clarity and agreement on deliverables."
    },
    "is_verified": true,
    "is_valid": true,
  ...
  },
  {
    ...
    "analysis": {
      ...
      "additional_notes": "To be updated by Admin"
    }
  }
]
};
