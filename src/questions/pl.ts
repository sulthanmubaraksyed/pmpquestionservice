export const questionsData = {
  "questions": [
  {
    ...
    "analysis": {
      ...
      "concepts_to_understand": "The Create WBS process is part of the Planning Process Group and the Scope Management Knowledge Area. Its purpose is to hierarchically decompose the total scope of work to be carried out by the project team to accomplish project objectives and create the required deliverables. It involves breaking down project deliverables and project work into smaller, more manageable components down to the work package level. This provides a structured view of what needs to be done, improves accuracy of cost, duration, and resource estimates, and facilitates better project control. It is applied after the scope statement is defined and before activities are defined, ensuring a clear, comprehensive, and agreed-upon scope baseline.",
      "additional_notes": "The purpose of the Create WBS process is to decompose the overall project scope into smaller, more manageable deliverables and work packages. This structured decomposition helps in:\n* Assigning responsibilities,\n* Estimating costs and duration,\n* Planning resources and schedules, and\n* Tracking progress.\nThe Work Breakdown Structure forms the foundation for all project planning and control.\n\nInputs\n1. Project Management Plan\n    * Particularly the Scope Management Plan, which defines how scope will be defined, validated, and controlled.\n2. Project Scope Statement\n    * Describes the deliverables, major assumptions, and constraints. At this early stage, it might still be evolving from high-level objectives.\n3. Requirements Documentation\n    * Captures stakeholder needs and expectations that will be transformed into deliverables.\n4. Enterprise Environmental Factors (EEFs)\n    * Includes organizational culture, structure, and available tools or systems that may influence decomposition.\n5. Organizational Process Assets (OPAs)\n    * Templates, WBS guidelines, historical project data, and lessons learned.\n\nTools and Techniques\n1. Decomposition\n    * The primary technique: breaking down deliverables into smaller, more manageable work components.\n2. Expert Judgment\n    * Involves consulting with stakeholders or subject matter experts to determine how best to structure the WBS.\n3. Facilitation Techniques\n    * Used in workshops or planning sessions with team members and stakeholders to collaboratively develop the WBS.\n\nOutputs\n1. Scope Baseline\n    * Composed of:\n        * Project Scope Statement\n        * WBS\n        * WBS Dictionary (describes each work package in detail)\n2. Project Documents Updates\n    * Updates to documents such as the requirements documentation or assumptions log based on breakdown insights."
    },
    "is_verified": true,
    "is_valid": true,
  ...
  },
  {
    ...
    "analysis": {
      ...
      "concepts_to_understand": "The 'Create WBS' process is integral to effective scope management. It takes the project scope statement and other inputs to systematically break down the project's work into smaller, more manageable pieces. The purpose is to define the full scope of the project in terms of deliverables and work packages, providing a clear and structured representation of the project's total work. This process ensures that all necessary work is identified and that no unnecessary work is included, laying a solid foundation for subsequent planning and execution activities. It is applied after the detailed scope statement has been created to further refine the project scope.",
      "additional_notes": "The purpose of the Create WBS process is to:\n* Decompose the project scope into smaller, manageable components called work packages.\n* Eliminate ambiguity by clearly defining all the deliverables.\n* Enable better cost estimating, resource assignment, scheduling, and risk management.\nThe WBS ensures everyone shares the same understanding of what needs to be delivered — and nothing more.\n\nInputs\n1. Project Management Plan\n    * Specifically, the Scope Management Plan, which outlines how scope will be defined, validated, and controlled.\n2. Project Scope Statement\n    * Contains detailed descriptions of deliverables, assumptions, and constraints. It forms the basis for building the WBS.\n3. Requirements Documentation\n    * Specifies stakeholder expectations and functional/non-functional requirements that must be included in the deliverables.\n4. Enterprise Environmental Factors (EEFs)\n    * Includes company culture, organizational structure, and available tools that may influence the decomposition approach.\n5. Organizational Process Assets (OPAs)\n    * Historical WBS templates, lessons learned, and decomposition guidelines from similar past projects.\n\nTools and Techniques\n1. Decomposition\n    * The core technique: systematically breaking down project deliverables into smaller, more manageable work packages until they can be scheduled, budgeted, and assigned.\n2. Expert Judgment\n    * Drawing on experience from experts, senior developers, or systems architects to guide how work should be structured.\n3. Facilitation Techniques\n    * Workshops, planning sessions, or group discussions to align the team and stakeholders on what needs to be delivered.\n\nOutputs\n1. Scope Baseline\n    * The most critical output, made up of:\n        * Project Scope Statement\n        * WBS – A hierarchical decomposition of the total project work.\n        * WBS Dictionary – Provides detailed descriptions for each work package.\n2. Project Document Updates\n    * May include updates to requirements documentation, assumptions log, or stakeholder register as decomposition reveals new details."
    },
    "is_verified": true,
    "is_valid": true,
  ...
  },
  {
    ...
    "analysis": {
      ...
      "concepts_to_understand": "The 'Create WBS' process is about systematically organizing and defining the total scope of the project. It involves decomposing project deliverables into smaller, more manageable components called work packages. The WBS provides a clear, hierarchical view of the project's entire scope, helping to clarify what needs to be done and preventing scope creep. It is a foundational step in project planning, enabling accurate estimates for time, cost, and resources, and facilitating effective communication about the project work. It is applied after the scope statement to further detail the work.",
      "additional_notes": "(Work Breakdown Structure) is a process within the Planning Process Group and falls under the Scope Management Knowledge Area. It is an essential process that helps break down the total scope of work into smaller, more manageable components. These components provide clarity and structure for planning, execution, monitoring, and control of project work.\n\nPurpose\nThe main goal of the Create WBS process is to: ✅ Decompose the total project scope (as defined in the Project Scope Statement) ✅ Create a hierarchical structure of deliverables and work packages ✅ Provide a clear roadmap for managing project scope\nA well-created WBS ensures that:\n* All work required is included (no missing scope)\n* No unnecessary work is performed (prevents scope creep)\n\nKey Inputs\n1. Project Management Plan\n    * Especially the Scope Management Plan\n2. Project Scope Statement\n    * Defines what is and isn’t included in the project\n3. Requirements Documentation\n    * Detailed stakeholder needs\n4. Enterprise Environmental Factors (EEFs)\n    * Organizational culture, systems, industry standards\n5. Organizational Process Assets (OPAs)\n    * WBS templates, historical WBS from similar projects\n\nTools and Techniques\n* Decomposition\n    * The core technique used in Create WBS.\n    * The project deliverables are progressively broken down into smaller components:\n        * Major deliverables → Sub-deliverables → Work Packages\n* Expert Judgment\n    * Subject matter experts may assist in determining how to structure the WBS.\n* Facilitation Techniques\n    * Workshops with stakeholders and team members help refine the WBS collaboratively.\n\nOutputs\n1. Scope Baseline\n    * Composed of:\n        * Approved Project Scope Statement\n        * WBS\n        * WBS Dictionary (detailed descriptions of each WBS element)\n2. Project Document Updates\n    * E.g., Requirements Documentation, Project Schedule"
    },
    "is_verified": true,
    "is_valid": false,
